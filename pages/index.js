      ...
      <main style={styles.main}>
        <div style={styles.wrap}>
          ...
          <div style={styles.btnRow}>
            <Link href="/preise" style={styles.btnPrimary}>Jetzt freischalten</Link>
            <Link href={`/login?next=/`} style={styles.btnGhost}>Login</Link>
          ...
          <div style={styles.linkColumn}>
            ...
            {/* ⭐ NEU: WILDKUNDE BUTTON */}
            <Link href="/wildkunde" style={styles.linkButton}>Wildkunde</Link>
          </div>
