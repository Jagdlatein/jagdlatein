...
export default function Schwarzwild() {
  const quiz = [
    ...
    },
    {
      ...
      a: ["ca. 5 Monate", "ca. 3 Monate + 3 Wochen + 3 Tage"],
      correct: 1,
    },
    {
      ...
      <div style={styles.wrap}>
        ...
        <section style={styles.section}>
          ...
          <ul style={styles.list}>
            <li>Einziges heimisches Haarraubwild mit echter Rüsselscheibe</li>
            <li>Gewicht: Keiler 90–200+ kg · Bache 60–120 kg</li>
            <li>Körperlänge: 120–180 cm · Schulterhöhe: 70–110 cm</li>
            <li>Lebensraum: Wälder, Felder, Feuchtgebiete, Agrarlandschaften</li>
            <li>Nahrung: Allesfresser – Eicheln, Bucheckern, Mais, Würmer, Aas</li>
        ...
        <section style={styles.section}>
          ...
          <ul style={styles.list}>
            ...
            <li>Bachen führen ihre Frischlinge sehr aktiv</li>
          </ul>
        </section>
        ...
        <section style={styles.section}>
          ...
          <ul style={styles.list}>
            <li>Keiler mit Haderern (unten) und Gewehren (oben)</li>
            <li>Hauer nutzen sich gegenseitig zu gefährlichen Waffen ab</li>
            <li>Zahnformel: I 3/3 · C 1/1 · P 4/4 · M 3/3 = 44</li>
            <li>Dicke Schwarte (Haut) schützt bei Keilern</li>
          </ul>
        </section>
        ...
        <section style={styles.section}>
          ...
          <ul style={styles.list}>
            <li>Schwarzes bis braunes Borstenkleid</li>
            <li>Frischlinge: hellbraun mit Streifen</li>
            <li>Überläufer: 1–2 Jahre alt</li>
            <li>Losung: wurstartig, grob, dunkel</li>
